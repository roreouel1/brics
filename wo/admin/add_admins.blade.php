              ...
              <div class="col-md-12 col-sm-12  ">
				...
				<p class="alert alert-{{ $msg }}">{{ Session::get('alert-' . $msg) }} <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a></p>
					...
					@endforeach
									...
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('admin.store')}}" enctype="multipart/form-data">
									     @csrf
                                        ...
                                        <div class="item form-group">
											...
											<div class="col-md-4 col-sm-4 ">
												<input type="text" id="password" name="password" required="required" class="form-control @error('password') is-invalid @enderror">
												@error('password')
                                    			<span class="invalid-feedback" role="alert">
                                      		  <strong>{{ $message }}</strong>
                                   			 </span>
                                        ...
                                        <div class="item form-group">
											...
											<div class="col-md-4 col-sm-4 ">
												<input type="text" id="password-confirm" name="password_confirmation"  required="required"  class="form-control">
											</div>
										</div>
