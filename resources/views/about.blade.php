          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0" data-aos="fade-up" data-aos-delay="100">
                <h3>WHO WE ARE</h3>
                 <p>Our Financial Services include the following; </p>
                <ul>
                  <li><i class="ri-check-double-line"></i> Financial Modelling</li>
                  <li><i class="ri-check-double-line"></i> Start Up Accounting</li>
                  <li><i class="ri-check-double-line"></i> Insurance Consulting</li>
                  <li><i class="ri-check-double-line"></i> Financial Inclusion Services </li>
                </ul>

                <p>Our Tech Services include the following; </p>
                <ul>
                  <li><i class="ri-check-double-line"></i> IT Consulting Services </li>
                  <li><i class="ri-check-double-line"></i> Cyber Security Services </li>
                  <li><i class="ri-check-double-line"></i> Digital Marketing & Strategy </li>
                  <li><i class="ri-check-double-line"></i>  Graphic Design & Animation Services  </li>
                  <li><i class="ri-check-double-line"></i>  Website & Apps Development </li>
                </ul>

                
                <p>Our Research Services include the following; </p>
                <ul>
                <li><i class="ri-check-double-line"></i> Corporate & Industrial Research </li>
                <li><i class="ri-check-double-line"></i>Academic Research & Advisory </li>
                <li><i class="ri-check-double-line"></i>  Market Research </li>
                </ul>
